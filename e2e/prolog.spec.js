...
test.describe("Prolog Integration Engine", () => {
    test("should load the website and successfully execute a Tau-Prolog query", async ({ page, }) => {
        await page.goto("./");
        ...
        await expect(resultBox).toContainText("Success! Mr. Jansen can teach the class.");
    });
});
